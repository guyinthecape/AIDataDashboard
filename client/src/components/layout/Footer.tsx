      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/products" className="text-gray-300 hover:text-white transition duration-150">
                  DataForge
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <div className="flex">
              <Input 
                ...
                className="w-full bg-indigo-900 border-indigo-800 rounded-r-none text-white placeholder:text-gray-400 focus-visible:ring-specifi-purple" 
              />
              <Button className="bg-specifi-purple hover:bg-opacity-90 transition duration-150 rounded-l-none">
