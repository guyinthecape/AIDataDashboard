  ...
  return (
    <div>
      ...
      <section className="bg-gradient-hero py-20 sm:py-24 lg:py-32">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-semibold text-midnight-indigo leading-tight tracking-wide">
              Powering Ethical AI with Reliable Data
            </h1>
            <p className="mt-6 text-lg sm:text-xl text-deep-charcoal max-w-3xl mx-auto">
            ...
            <div className="mt-10 flex flex-col sm:flex-row justify-center gap-4">
              <Button 
                className="bg-specifi-purple hover:bg-opacity-90 focus:ring-specifi-purple text-white px-6 py-6 h-auto transition-all duration-200 transform hover:-translate-y-1 text-base"
                size="lg"
              >
                Request Demo
              </Button>
              <Button 
                variant="outline" 
                className="border-specifi-purple text-specifi-purple hover:bg-soft-lilac focus:ring-specifi-purple px-6 py-6 h-auto transition-all duration-200 transform hover:-translate-y-1 text-base"
                size="lg"
              >
      ...
      <section className="py-16 bg-off-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-semibold text-center text-midnight-indigo mb-12">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <Card className="bg-white hover:shadow-md transition-shadow duration-300 p-6 flex flex-col items-center text-center">
              <div className="h-16 w-16 rounded-full bg-soft-lilac flex items-center justify-center mb-4">
                <i className="fas fa-hammer text-specifi-purple text-2xl"></i>
              </div>
              <h3 className="text-xl font-semibold text-midnight-indigo mb-2">DataForge™</h3>
            ...
            <Card className="bg-white hover:shadow-md transition-shadow duration-300 p-6 flex flex-col items-center text-center">
              <div className="h-16 w-16 rounded-full bg-soft-lilac flex items-center justify-center mb-4">
                <i className="fas fa-book-atlas text-specifi-purple text-2xl"></i>
              </div>
              <h3 className="text-xl font-semibold text-midnight-indigo mb-2">Atlas Library™</h3>
              <p className="text-deep-charcoal">
            ...
            <Card className="bg-white hover:shadow-md transition-shadow duration-300 p-6 flex flex-col items-center text-center">
              <div className="h-16 w-16 rounded-full bg-soft-lilac flex items-center justify-center mb-4">
                <i className="fas fa-cube text-specifi-purple text-2xl"></i>
              </div>
              <h3 className="text-xl font-semibold text-midnight-indigo mb-2">Prism Packs™</h3>
              <p className="text-deep-charcoal">
            ...
            <Card className="bg-white hover:shadow-md transition-shadow duration-300 p-6 flex flex-col items-center text-center">
              <div className="h-16 w-16 rounded-full bg-soft-lilac flex items-center justify-center mb-4">
                <i className="fas fa-shield-alt text-specifi-purple text-2xl"></i>
              </div>
              <h3 className="text-xl font-semibold text-midnight-indigo mb-2">Sentinel Audit™</h3>
              <p className="text-deep-charcoal">
